...
#### Quick R Tips
To operate in R, you can run single commands or scripts (essentially text files with lists of commands), which are processed in the console. Each command or function can have parameters defined by the user. A few quick tips:   
...
# 3. Before Visualization: Understanding your Data {.tabset}

Before visualizing data, it's important to:  
1. define your research question,  
2. understand the underlying data you're working with, and
3. prepare the appropriate data as needed for visualization. 

The first step of defining your research question may seems trivial, but it guides many of your visualization decisions. Knowing your research question allows you to identify the variables relevant to your visualization or analysis, as well as how you think they'll relate to each other.

Once you've defined your research question, you can identify the number of variables you're interested in comparing---i.e. the **dimensionality** of your analysis---as well as the **type of data** contained in each variable of interest---e.g. is it continuous or discrete? 

Sometimes a final step is required, where the data needs to be organized or re-structured before the final step of visualization.
...
To illustrate what different dimensions may look like, let's take data on your friends Jane, John, and Moe to document how many cats and dogs they own. If our research question is "Is having a dog related to having a cat?" you are interested in the relationship between two variable: (1) having a dog, (2) having a cat. Since you're interested in two variables, this analysis is **2-dimensional**:  

![](images/dimensionality-2var.png)  

If we also ask your friends about their pet mice and want to know whether having any one of those three pets is related to having another pet, you'd now be interested in three variables (number of cats, dogs, mice), or a **3-dimensional** analysis:  
...
*Definition taken from* A Primer of Ecological Statistics 2^nd^ Ed. *by Nicholas J. Gotelli and Aaron M. Ellison*
...
Once you know the **dimensionality** and **type of data** needed for your research question, you're ready to decide what you'd like to visualize and you'd like to do it.
...
Often times the data you receive is not formatted for visualization, or needs to be transformed. In such cases, R has a variety of function that can help.
