...
3. **Understanding your Data Before Visualization**
      -Dimensionality
      i. Organizing and Manipulating Data
            - Scaling
            - Normalizing
            - Aggregating
...
Before visualizing data, it's important to understand the underlying data you're working with. The first step is identifying the number of variables you'd interested in comparing---i.e. the dimensionality of your analysis---and the second step is identifying the type of data contained in each variable of interest---e.g. is it continuous or categorical?

#### Dimensionality

The number of variables you're interested in comparing determines the type(s) of visualizations available to you.  

Let's say you want to know more about your friends' pets. You take data on your friends Jane, John, and Moe and document how many cats and dogs they have. You're interested in the seeing the relationship between having a cat (one variable) and having a dog (another variable). Since you're interested in two variables, this analysis is **2-dimensional**:  
...
Knowing what kind of data you're visualizing determines a great deal of your visualization (and statistics) possiblities. Each one of your variables should be classified as one of the following:

|DATA TYPE   |Defined As...                  | Example                       |
|:-----------|:-----------------------------:|:-----------------------------:|
|**Continuous** |any value over a continuous range of numbers|Height. Can theoretically take on any number over a certain range.|
|**Discrete (ordered)**|only taking on particular values that have an order in relation to each other| Number of pets your friends own. |
|**Discrete (unordered)**|can think of as bins, no in-between values between each bin and no inherent order to the types of bins| Your friend's names. |

#### Putting it together...

Once you know the type of data you have and the dimensionality of your desired visualization, you're ready to decide what you'd like to show and you'd like to do it.

To give an example of the possibilities:

![Made by A. Abela](images/pick-your-visualization.png)

### 3.i. Organizing and Manipulating Data
...
### 3.ii. Choosing Appropriate Visualization(s)
