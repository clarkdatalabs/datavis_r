...
Have you defined your research question? Know the dimensionality and the types of data contained in your data set? Have you organized your data as needed? If so, you're finally ready to start visualizing! 

### Visualizing 1 Variable

Oftentimes it's useful to visualize a singular variable to understand the size and shape of its distribution, and to see whether any outliers exist.
...
By adding breaks as a parameter we can increase or decrease the bin-size
```{r}
...
Boxplots show various useful measures of distribution, including the average, the interquartile range, and any outliers in the data.

```{r}
#Boxplot
###########
boxplot(census$area, main="County Area ACS 2006-2010")
boxplot(census$age, main="")
...
If your final visual looks boring, it probably means it's time to get better data!
