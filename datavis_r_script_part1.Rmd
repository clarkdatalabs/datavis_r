...
(1.) The first step of defining your research question may seems trivial, but it guides many of your visualization decisions. Knowing your research question allows you to identify the variables relevant to your visualization or analysis, as well as how you think they'll relate to each other.

(2.) Once you've defined your research question, you can identify the number of variables you're interested in comparing---i.e. the **dimensionality** of your analysis---as well as the **type of data** contained in each variable of interest---e.g. is it continuous or discrete? 

(3.) Sometimes a final step is required, where the data needs to be organized or re-structured before the final step of visualization.
...
```
![](images/scatter_logpop_v_hh_inc.tiff)
